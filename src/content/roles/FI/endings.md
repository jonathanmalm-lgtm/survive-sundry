...
endings:
  - id: 1
    ...
    shareVariants:
      ...
      - "FIRED. AT LEAST I GREETED PEOPLE ON THE WAY OUT."
  - id: 2
    title: "Reassigned. First Impressions Scheduling and Compliance Coordinator."
    condition: "Ministry < 40, Relational < 40, Self-Aware > 60"
    shareText: "I'M NOW THE FIRST IMPRESSIONS SCHEDULING AND COMPLIANCE COORDINATOR."
    shareVariants:
      - "I'M NOW THE FIRST IMPRESSIONS SCHEDULING AND COMPLIANCE COORDINATOR."
      - "FIRST IMPRESSIONS SCHEDULING AND COMPLIANCE COORDINATOR. AT EXECUTION CHURCH."
  - id: 3
