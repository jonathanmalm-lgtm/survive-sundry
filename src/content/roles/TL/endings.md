...
endings:
  - id: 1
    ...
    shareVariants:
      ...
      - "FIRED. AT LEAST I HAVE THE SUBWOOFER."
  - id: 2
    title: "Reassigned. Tech Scheduling and Compliance Coordinator."
    condition: "Ministry < 40, Relational < 40, Self-Aware > 60"
    shareText: "I'M NOW THE TECH SCHEDULING AND COMPLIANCE COORDINATOR."
    shareVariants:
      - "I'M NOW THE TECH SCHEDULING AND COMPLIANCE COORDINATOR."
      - "TECH SCHEDULING AND COMPLIANCE COORDINATOR. AT EXECUTION CHURCH."
  - id: 3
  ...
  - id: 4
    ...
    shareText: "REDEMPTION CITY CHURCH CALLED. WE'RE OUT."
    shareVariants:
      - "REDEMPTION CITY CHURCH CALLED. WE'RE OUT."
      - "THEY CALLED. FULL BENEFITS. RELOCATION PACKAGE. WE ANSWERED."
  - id: 5
...
The meeting starts normally. Then the door opens. It's Tanner. He is 24. He has a podcast with 340 subscribers and a leather journal labeled "VISION DOWNLOAD" in large letters. He spent six months at Bethel and came back with a vocabulary that is mostly the word "activation." He sits down next to you. "I had some initial thoughts about the tech direction," he says. "God's been speaking to me about frequency." You look at Pastor Dave. Pastor Dave is already looking at his phone.
